...
let website = "/ODataTypeProvider"

let githubLink = "http://github.com/caindy/ODataTypeProvider"

// Specify more information about your project
let info =
  [ "project-name", "ODataTypeProvider"
    "project-author", "Christopher Atkins"
    "project-summary", "an F# type provider for OData resources"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/ODataTypeProvider" ]
